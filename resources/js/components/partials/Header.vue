<template>
    <div>
        <!-- TopBar -->
        <nav v-if="authenticated" class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                        ...
                        <a class="dropdown-item" href="javascript:void(0);" @click.prevent="handleLogout">
